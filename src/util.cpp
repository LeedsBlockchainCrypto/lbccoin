...
const char * const BITCOIN_CONF_FILENAME = "lbccoin.conf";
const char * const BITCOIN_PID_FILENAME = "lbccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LBCcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/LBCcoin";
#else
    // Unix
    return pathRet / ".lbccoin";
#endif
#endif
}
